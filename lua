...
WindUI:Popup({
    ...
    Title = CreateGradientText("AZAZIL Hub", Colors.Red, Colors.Green),
...
local Window = WindUI:CreateWindow({
    ...
    Title = CreateGradientText("AZAZIL Hub | Murder Mystery 2", Colors.Red, Colors.Green),
...
local function CheckGamepass()
    ...
    if success then
        ...
        if ownsGamepass then
            ...
            print("[Gamepass Check] âœ… You own the premium gamepass!")

        else

            maxCandyCapacity = 40

            print("[Gamepass Check] âŒ You do NOT own the premium gamepass.")
        ...
        print("[Gamepass Check] âš ï¸ Failed to check ownership.")
